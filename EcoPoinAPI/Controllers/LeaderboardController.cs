...
namespace EcoPoinAPI.Controllers
{
    ...
    public class LeaderboardController : ExtBaseController
    {
        ...
        public ActionResult GetAll(int page = 1, int size = 10, string range = "alltime")
        {
            ...
            var query = dbc.Users.Where(u => u.Role == "resident").Include(u => u.DepositPoints).Include(u => u.RedemptionPoints).Include(u => u.DepositResidents).ThenInclude(d => d.WasteType).AsQueryable();
